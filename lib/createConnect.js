...
function createConnect(mapStoreToValues, handlers, store) {
    return function connect(Component) {
        var mapStoreToHandlers = function (store, props) {
            return Object.keys(handlers).reduce(function (previous, handlerName) {
                var _a;
                return Object.assign({}, previous, (_a = {}, _a[handlerName] = handlers[handlerName](store, props), _a));
            }, {});
        };
        return /** @class */ (function (_super) {
            ...
            function class_1(props, context) {
                ...
                _this.sub = null;
                _this.state = Object.assign({}, mapStoreToValues(store, props), mapStoreToHandlers(store, props));
                return _this;
            }
            class_1.prototype.componentDidMount = function () {
                ...
                this.sub = store.subscribe(function () {
                    ...
                    _this.setState(Object.assign({}, _this.state, mapStoreToValues(store, _this.props)));
                });
            };
            class_1.getDerivedStateFromProps = function (nextProps, prevState) {
                return Object.assign({}, prevState, mapStoreToValues(store, nextProps), mapStoreToHandlers(store, nextProps));
            };
