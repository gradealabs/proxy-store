    ...
    return function connect(Component) {
        var mapStoreToHandlers = function (props) {
            return Object.keys(_handlers).reduce(function (previous, handlerName) {
                var _a;
                return Object.assign({}, previous, (_a = {}, _a[handlerName] = _handlers[handlerName](store, props), _a));
            }, {});
        };
        return /** @class */ (function (_super) {
            ...
            function class_1(props, context) {
                ...
                _this.sub = null;
                _this.state = Object.assign({}, _mapStoreToValues(store, props), mapStoreToHandlers(props));
                return _this;
            }
            class_1.prototype.componentDidMount = function () {
                ...
                this.sub = store.subscribe(function () {
                    ...
                    _this.setState(_mapStoreToValues(store, _this.props));
                });
            };
            class_1.getDerivedStateFromProps = function (nextProps, prevState) {
                var hasChanged = Object.keys(nextProps).some(function (propName) { return nextProps[propName] !== prevState[propName]; });
                if (hasChanged) {
                    return Object.assign({}, prevState, _mapStoreToValues(store, nextProps), mapStoreToHandlers(nextProps));
                }
                return null;
            };
