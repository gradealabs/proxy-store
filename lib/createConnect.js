...
function createConnect(mapStoreToValues, handlers, store) {
    var mapStoreToValuesOmitted = typeof mapStoreToValues !== 'function' && typeof mapStoreToValues === 'object' && Object.keys(mapStoreToValues).length && store === undefined;
    var handlersOmitted = typeof mapStoreToValues === 'function' && store === undefined;
    var _mapStoreToValues = mapStoreToValuesOmitted ? null : mapStoreToValues;
    var _handlers = mapStoreToValuesOmitted ? mapStoreToValues : (handlersOmitted ? null : handlers);
